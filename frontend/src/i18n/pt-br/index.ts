  ...
  translation: {
    ...
    model: {
      ...
      'claude-v5-fable': {
        ...
        description:
          'Modelo mais capaz de disponibilidade geral da Anthropic, oferecendo a maior inteligência disponível para as tarefas de agente de longa duração mais exigentes.',
      },
      'claude-v3-opus': {
        label: 'Claude 3 (Opus)',
