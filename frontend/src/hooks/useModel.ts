...
const useModel = (
  ...
  const availableModels = useMemo<ModelItem[]>(() => {
    return [
      ...
      {
        modelId: 'claude-v5-opus',
        label: t('model.claude-v5-opus.label'),
        description: t('model.claude-v5-opus.description'),
        supportMediaType: CLAUDE_SUPPORTED_MEDIA_TYPES,
        supportReasoning: true,
      },
      {
      ...
      {
        modelId: 'claude-v5-fable',
        label: t('model.claude-v5-fable.label'),
        description: t('model.claude-v5-fable.description'),
        supportMediaType: CLAUDE_SUPPORTED_MEDIA_TYPES,
        supportReasoning: true,
      },
      {
